...
shiny::HTML('<div id="wrap"><iframe id="scaled-frame" src="https://ppgcr-unisuam.github.io/observatoriocr/"></iframe>
</div>')

shiny::HTML("<h1>UFC | PPGFisio</h1>")
shiny::HTML('<div id="wrap"><iframe id="scaled-frame" src="https://ppgfisioufc.github.io/PPGFisio_UFC/"></iframe>
</div>')

shiny::HTML("<h1>UFTM-UFU | PPGFisio</h1>")
shiny::HTML('<div id="wrap"><iframe id="scaled-frame" src="https://ppgfisiouftmufu.github.io/ObservatorioUFTM_UFU/"></iframe>
</div>')

shiny::HTML("<h1>UFRN | PPGCR</h1>")
shiny::HTML('<div id="wrap"><iframe id="scaled-frame" src="https://ppgfisioterapia.github.io/observatorioUFRN/"></iframe>
</div>')

shiny::HTML("<h1>USP | PPGReab</h1>")
shiny::HTML('<div id="wrap"><iframe id="scaled-frame" src="https://ppgreab.github.io/Observatorio-PPGPosReab-USP/"></iframe>
</div>')

shiny::HTML("<h1>UNISUAM | PPGDL")
shiny::HTML('<div id="wrap"><iframe id="scaled-frame" src="https://ppgcr-ppgdl.github.io/observatoriodl/"></iframe>
</div>')
```
