...
data.to.abbrev <- as.character(summ.AC.LP$AC)
source("Scripts/get-abbrev.R", local = TRUE)
summ.AC.LP$AC <- as.factor(abbrev)
  
data.to.abbrev <- as.character(summ.AC.LP$LP)
source("Scripts/get-abbrev.R", local = TRUE)
summ.AC.LP$LP <- as.factor(abbrev)
...
# plot 4 (total de projetos por tipo, por ano)
