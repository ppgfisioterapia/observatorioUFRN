...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Artigo em Periódico (¹Discente, ²Egresso, ³Docente)")
} else {
...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Editoria (¹Discente, ²Egresso, ³Docente)")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Livro (¹Discente, ²Egresso, ³Docente)")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Trabalho em Anais (¹Discente, ²Egresso, ³Docente)")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Apresentação de Trabalho (¹Discente, ²Egresso, ³Docente)")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Organização de Evento (¹Discente, ²Egresso, ³Docente)")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Curso de Curta Duração (¹Discente, ²Egresso, ³Docente)")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Material Didático e Instrucional (¹Discente, ²Egresso, ³Docente)")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Patente (¹Discente, ²Egresso, ³Docente)")
} else {
  cat("*Sem dados para exibir*")
}
...
if (dim(produtos.df)[1] != 0) {
  ...
  source("Scripts/table-with-buttons.R", local = knitr::knit_global())
  create_dt(table, title = "Produção - Aplicativo (¹Discente, ²Egresso, ³Docente)")
} else {
  cat("*Sem dados para exibir*")
}
