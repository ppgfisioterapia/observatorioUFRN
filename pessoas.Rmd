...
# periodo
n.end <- as.numeric(format(Sys.Date(), "%Y")) - 0
n.start <- as.numeric(format(Sys.Date(), "%Y")) - 5
...
# periodo
n.end <- as.numeric(format(Sys.Date(), "%Y")) - 5
n.start <- as.numeric(format(Sys.Date(), "%Y")) - 10
# egressos dos últimos 5 anos
periodo <- n.start:n.end
periodo <- periodo[periodo %in% anos]
...
# periodo
n.end <- as.numeric(format(Sys.Date(), "%Y")) - 10
n.start <- as.numeric(format(Sys.Date(), "%Y")) - 15
# egressos dos últimos 5 anos
periodo <- n.start:n.end
periodo <- periodo[periodo %in% anos]
