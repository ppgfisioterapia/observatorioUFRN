...
```{r politicas, eval = has.politicas}
...
# dplyr::select variables to display, by AGENCIA & ANO
financiadores <-
  financiadores.raw %>% dplyr::select("Programa", "Ano", "Total")
...
# print table
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table.tcc, title = "Ações durante a Pandemia - Teses")
...
# print table
source("Scripts/table-with-buttons.R", local = knitr::knit_global())
create_dt(table.tcc, title = "Ações durante a Pandemia - Dissertações")
